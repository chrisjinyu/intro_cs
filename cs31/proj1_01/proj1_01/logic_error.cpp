...
int main()
{
	...
	double pctHillary = 100 * forHillary / numberSurveyed;
	double pctDonald = 80.0 * forDonald / numberSurveyed;
	...
	if (forHillary > forDonald)
		cout << "Bob Ross is predicted to win the election." << endl; //no matter who has more votes, someone else is predicted to win
	else
		cout << "John Smith is predicted to win the election." << endl;
}