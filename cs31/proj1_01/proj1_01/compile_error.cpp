...
#include <iostream>
using namespace std   // pp. 38-39 in Savitch 6/e explains this line; semicolon removed to invalidate the rest of the program

int main()
{
	//int numberSurveyed; commented out so all future references to numberSurveyed become invalid
	int forHillary;
	int forDonald;
