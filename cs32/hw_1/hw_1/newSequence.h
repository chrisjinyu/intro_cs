...
#else
typedef unsigned long ItemType;		//place any object type here, other than string
#endif
...
public:
	...
	Sequence(int size);  // Create an empty sequence with a max size of given argument
