#include "Arena.h"		//include own header
#include "Rat.h"		//completes Rat class declaration
#include "Player.h"		//completes Player class declaration
...
{
	return m_history;					//trivial, return reference
}